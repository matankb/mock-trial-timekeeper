...
export interface TeamAccountHowItWorksRouteProps {
  signedIn: boolean;
}
...
const TeamAccountHowItWorks: React.FC<
  ScreenProps<ScreenName.TEAM_ACCOUNT_HOW_IT_WORKS>
> = ({ route }) => {
  ...
  const slides: SlideData[] = signedIn
    ? [
        ...
        {
          image: require('../../../assets/promos/team-trials/6.5-upload-menu.png'),
          text: 'Upload the trial',
          subtitle:
    ...
    : [
        ...
        },
        {
          ...
          subtitle:
            "After logging in, members can chose which team they're on.",
        },
        {
        ...
        {
          image: require('../../../assets/promos/team-trials/9-trial-breakdown.png'),
